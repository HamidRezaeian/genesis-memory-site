...
export const CLIENTS = [
  ...
  { id: 'claude_code', name: 'Claude Code', fam: 'CLI', caps: ['Hook', 'MCP', 'Proxy'], path: '~/.claude/settings.json + ~/.claude.json', fmt: 'json', snippet: JSON.stringify({ env: { GENESIS_DAEMON_DB: DB }, hooks: { UserPromptSubmit: [{ hooks: [{ type: 'command', command: `"${PY}" "~/genesis_memory/hooks/subconscious_hook.py" --claude` }] }] } }, null, 2) },
